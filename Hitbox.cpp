...
// Accessors
const sf::Vector2f& Hitbox::getPosition() const { return this->hitbox.getPosition(); }
const sf::FloatRect Hitbox::getGlobalBounds() const { return this->hitbox.getGlobalBounds(); }
